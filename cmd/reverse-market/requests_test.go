...
func TestRequestsEndpoint(t *testing.T) {
	...
	tests := []struct {
		...
		{"Get all requests with search", "/user/requests?search=1", nil, http.StatusOK, []byte(`[{"id":1,"username":"Ivanov Ivan","category_id":1,"name":"name 1","item_name":"item name 1","description":"description 1","photos":[],"price":100,"quantity":1,"date":"14.12.2020","tags":[{"id":1,"name":"Синий"},{"id":2,"name":"Крансый"}],"best_proposal_id":1}]`)},
